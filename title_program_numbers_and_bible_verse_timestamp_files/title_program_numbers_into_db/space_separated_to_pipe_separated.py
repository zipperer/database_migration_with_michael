...
filename_file_to_write = 'program_number_and_title_pipe_separated.csv'
...
with open(filename_file_to_write, 'w', newline='') as file_object_file_to_write:
    csv_writer = csv.DictWriter(file_object_file_to_write, fieldnames=fieldnames_for_input_file, delimiter='|')
